...
export type SmsDocumentSenderBindingDto = {
  id: string;
  documentId: string;
  senderId: string;
...
export type SmsDocumentRecipientBindingDto = {
  documentId: string;
  recipientIds: string[];
  recipients: SmsRecipientRecordDto[];
};
...
export type SmsDispatchHistoryItemDto = {
  dispatch: SmsDispatchRecordDto;
  targets: SmsDispatchTargetDto[];
};
...
export type SmsSettingsUpdateInput = {
  defaultSenderPhoneNumber?: string | null;
  messagePrefix?: string | null;
  documentSenderBindings?: Array<{
    documentId: string;
    senderId: string | null;
  }>;
  documentRecipientBindings?: Array<{
    documentId: string;
    recipientIds: string[];
  }>;
};
...
export type EmailDispatchHistoryItemDto = {
  dispatch: EmailDispatchRecordDto;
  targets: EmailDispatchTargetDto[];
};
