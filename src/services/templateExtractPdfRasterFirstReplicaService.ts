...
import type {
  ...
  TemplateExtractFrameGroupLegacyVersion,
...
const buildPipelineTrace = (
  ...
  frameGroupVersion: response.frameGroupVersion as TemplateExtractFrameGroupVersion | undefined,
...
export const TemplateExtractPdfRasterFirstReplicaService = {
  ...
  async extractPdfSource(
    ...
    frameGroupVersion: TemplateExtractFrameGroupVersion = 'fv1.11-default'
    ...
    try {
      ...
      const actualLegacyFrameGroupVersion = String(
        toLegacyTemplateExtractFrameGroupVersion(response.frameGroupVersion || legacyFrameGroupVersion)
      ) as TemplateExtractFrameGroupLegacyVersion;
      const actualFrameGroupVersion = String(
        toPublicTemplateExtractFrameGroupVersion(actualLegacyFrameGroupVersion)
      ) as TemplateExtractFrameGroupVersion;
