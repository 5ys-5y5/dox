...
export const TemplateExtractSnapshotV11Layout = {
  // BUILDHTML-PDF-11
  // v11 snapshot 은 v10의 form clone을 유지하되,
...
export const TemplateExtractSnapshotV11Service = {
  async extractPdfSource(fileName: string, bytes: Uint8Array): Promise<TemplateExtractResolvedSource> {
    ...
    const clonedHtml = TemplateExtractSnapshotV11Layout.buildCloneHtml(sourceTitle, rawText, layout);
