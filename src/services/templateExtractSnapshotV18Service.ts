...
export const TemplateExtractSnapshotV18Service = {
  // BUILDHTML-PDF-19_SNAPSHOT_V18
  // v18은 직전 active 상태를 그대로 고정합니다.
  // text layer PDF -> pdf-form-v18
  ...
  async extractPdfSource(fileName: string, bytes: Uint8Array): Promise<TemplateExtractResolvedSource> {
    ...
    const clonedHtml = TemplateExtractPdfLayoutService.buildCloneHtml(sourceTitle, rawText, layout, '18');
