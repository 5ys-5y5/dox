...
export const TEMPLATE_FRAME_POSITION_MODE_ATTR = 'data-template-frame-position-kind';
...
export const TEMPLATE_FRAME_RUNTIME_MODE_ATTR = 'data-template-runtime-kind';
...
export const TEMPLATE_USAGE_PREVIEW_MODE_ATTR = 'data-template-usage-preview-active';
...
export const TEMPLATE_USAGE_PREVIEW_FILE_MODE_ATTR = 'data-template-usage-preview-file-kind';
...
export const TEMPLATE_USAGE_PREVIEW_RUNTIME_MODE_ATTR = 'data-template-usage-preview-runtime-kind';
...
export const TEMPLATE_FRAME_RELATIVE_ANCHOR_SOURCE_EDGE_Y_ATTR = 'data-template-frame-relative-anchor-source-edge-y';
export const TEMPLATE_FRAME_RELATIVE_ANCHOR_TARGET_EDGE_Y_ATTR = 'data-template-frame-relative-anchor-target-edge-y';
...
export const SELECTION_TONEDOWN_OVERLAY_MODE_ATTR = 'data-v106-selection-tonedown-state';
...
export const TEMPLATE_PREVIEW_TEXT_CANVAS_EDIT_MODE_ATTR = 'data-v106-text-canvas-edit-active';
