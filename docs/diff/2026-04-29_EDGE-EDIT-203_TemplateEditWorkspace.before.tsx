...
export default function TemplateEditWorkspace({ initialTemplateId = '' }: TemplateEditWorkspaceProps) {
  ...
  }, [buildLiveEdgeTopologySnapshot, reconcileLiveEdgeSelection, renderedPreviewHtml, requestPreviewTextFit]);
