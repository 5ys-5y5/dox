...
export const TemplateExtractPdfLayoutService = {
  // BUILDHTML-PDF-10
  // current 경로는 v5의 구조적 form clone을 다시 기본으로 삼되,
  // geometry/layout 좌표는 "섹션이 좌우 병렬인지"와 "값 칸 시작 위치"를 보정하는 데만 사용합니다.
  // structured form parsing 이 실패한 PDF만 generic html-grid fallback 으로 내려갑니다.
