    ...
    if (resizeState && event.pointerId === resizeState.pointerId) {
      ...
      if (activeEdgeResizeTargets.length > 0) {
        ...
        resizeState.edgeAutosnapLockX =
          Math.abs(snappedDeltaX - constrainedDeltaX) >= 0.5 ? snappedResultX.nextLock : null;
        resizeState.edgeAutosnapLockY =
          Math.abs(snappedDeltaY - constrainedDeltaY) >= 0.5 ? snappedResultY.nextLock : null;
