...
| `METADATA-SELECTION-RELATION-02` | 속성 탭 관계 connector/dot/outline은 항목 선택 여부와 무관하게 미선택 상태와 같은 수로 유지한다. | `TemplateEditWorkspace.before.tsx` | 완료 |
...
- 2026-05-11: 속성 탭의 관계 connector 렌더링 조건에서 “선택된 관계만 connector 유지” 제한을 제거했다. 항목 선택 중에도 미선택 상태와 같은 관계 line/dot/outline 수가 유지된다.
