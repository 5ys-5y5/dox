...
const buildCloneStyleHtml = () => `    <style>
      ...
      .template-clone--pdf-form-v13 h1 {
        margin: 0 0 12px;
        text-align: center;
        font-size: 24px;
        font-weight: 700;
      ...
      .template-clone--pdf-form-v13 table {
        width: 100%;
      ...
      .template-clone--pdf-form-v13 th,
      .template-clone--pdf-form-v13 td {
...
const buildStructuredCloneHtml = (structured: StructuredWorkOrder, layout?: TemplateExtractPdfLayoutModel | null) => `<section data-template-extract-draft="true" data-template-clone="pdf-form-v13">
  <div class="template-clone template-clone--pdf-form-v13">
${buildCloneStyleHtml()}
    <h1>작업지시서</h1>
...
export const TemplateExtractPdfLayoutService = {
  // BUILDHTML-PDF-13
  // active 경로는 v12 snapshot을 보존한 상태에서
  // 1) 병렬 섹션 heading/value block을 실제 폼처럼 full-height rowspan으로 유지하고
  // 2) v5/v10 계열의 form clone 접근을 계속 개선합니다.
