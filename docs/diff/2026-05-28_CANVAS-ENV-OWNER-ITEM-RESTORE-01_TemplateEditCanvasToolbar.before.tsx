  ...
  <>
    ...
    <CardHeader className={`space-y-4 pb-3 ${canvasFullscreen ? 'shrink-0' : ''}`}>
      <div className="flex items-center gap-3">
        {showCanvasTitle ? (
        <div className="min-w-0 shrink-0" {...canvasOwnerSettingDefinitionItem('canvasToolbarVisibility.showCanvasTitle')}>
        ...
        {readMode ? null : (
          <div className="ml-auto flex min-w-0 flex-1 items-center justify-end gap-2">
            {renderTemplateNameInput ? (
              <div className="relative min-w-0 max-w-[420px] flex-1" {...canvasOwnerSettingDefinitionItem('canvasToolbarVisibility.showTemplateNameInput')}>
            ...
            {renderSaveButton ? (
              <Button
                {...canvasOwnerSettingDefinitionItem('canvasToolbarVisibility.showSaveButton')}
                onClick={onSave}
            ...
            {renderTodoButton ? (
              <Button
                {...canvasOwnerSettingDefinitionItem('canvasToolbarVisibility.showTodoButton')}
                type="button"
                variant="outline"
    ...
    {showToolbarBody ? (
      ...
      <div className="v106-canvas-toolbar flex w-full min-w-0 flex-wrap items-stretch gap-2 md:gap-3">
        {renderPreviewToggle ? (
        <div className={`${canvasToolbarGroupClassName} shrink-0`} {...canvasOwnerSettingDefinitionItem('canvasToolbarVisibility.showPreviewToggle')}>
          <button
            type="button"
        ...
        {renderInteractionModeControls ? (
          <div
            ...
            aria-label="캔버스 조작 모드"
            {...canvasOwnerSettingDefinitionItem('canvasToolbarVisibility.showInteractionModeControls')}
          >
            <button
              type="button"
        ...
        <div
          ...
          {...canvasOwnerSettingDefinitionItem('canvasToolbarVisibility.showHistoryControls')}
        >
          <button
            type="button"
        ...
        <div
          ...
          {...canvasOwnerSettingDefinitionItem('canvasToolbarVisibility.showZoomControls')}
        >
          <button
            type="button"
        ...
        {renderFullscreenControl ? (
        <div className={`${canvasToolbarGroupClassName} shrink-0`} {...canvasOwnerSettingDefinitionItem('canvasToolbarVisibility.showFullscreenControl')}>
          <button
            type="button"
        ...
        {renderEditSettingsToggle ? (
          <div className={`${canvasToolbarGroupClassName} shrink-0`} {...canvasOwnerSettingDefinitionItem('canvasToolbarVisibility.showEditSettingsToggle')}>
            <button
              type="button"
        ...
        {renderSelectionPanelTabs ? (
          <div className="shrink-0" {...canvasOwnerSettingDefinitionItem('canvasToolbarVisibility.showSelectionPanelTabs')}>
            <div
