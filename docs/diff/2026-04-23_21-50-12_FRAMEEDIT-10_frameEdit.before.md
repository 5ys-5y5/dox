...
1. `docs/diff/YYYY-MM-DD_FRAMEEDIT-03_templateFrameEditGeometryService.before.md`
...
1. `docs/diff/YYYY-MM-DD_FRAMEEDIT-04_templateFrameEditHtmlService.before.md`
...
1. `docs/diff/YYYY-MM-DD_FRAMEEDIT-05_extract-page.before.tsx`
2. `docs/diff/YYYY-MM-DD_FRAMEEDIT-05_templateFrameEditGeometryService.before.ts`
...
1. `docs/diff/YYYY-MM-DD_FRAMEEDIT-06_extract-page.before.tsx`
2. `docs/diff/YYYY-MM-DD_FRAMEEDIT-06_templateFrameEditGeometryService.before.ts`
...
1. `docs/diff/YYYY-MM-DD_FRAMEEDIT-07_extract-page.before.tsx`
...
1. `docs/diff/YYYY-MM-DD_FRAMEEDIT-08_extract-page.before.tsx`
...
1. `docs/diff/YYYY-MM-DD_FRAMEEDIT-10_extract-page.before.tsx`
...
| `FRAMEEDIT-01` | 대기 | 후속 코드 구현 전 사용자 확정 필요 |
| `FRAMEEDIT-02` | 대기 | DTO 신규 파일 제안 |
| `FRAMEEDIT-03` | 대기 | Geometry service 신규 파일 제안 |
| `FRAMEEDIT-04` | 대기 | HTML serialization service 신규 파일 제안 |
| `FRAMEEDIT-05` | 대기 | 병합 validation 필요 |
| `FRAMEEDIT-06` | 대기 | midpoint fallback 제거 필요 |
| `FRAMEEDIT-07` | 대기 | 생성/삭제 UI 필요 |
| `FRAMEEDIT-08` | 대기 | chain key/depth 입력 필요 |
| `FRAMEEDIT-09` | 선택 대기 | API adapter는 사용자 확정 후 추가 |
| `FRAMEEDIT-10` | 대기 | 저장/재조회 검증 필요 |
