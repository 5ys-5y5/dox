...
export const TemplatePersistencePanel = ({
  ...
  return (
  <div className="space-y-6" {...canvasOwnerSettingDefinitionItem('hidePersistencePanel')}>
    {additionalControlPanels}
    <Card className="border-slate-200">
      ...
      <CardContent className="space-y-4">
        {showTemplateList ? (
        <div className="space-y-2" {...canvasOwnerSettingDefinitionItem('persistenceVisibility.showTemplateList')}>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-2" {...canvasOwnerSettingDefinitionItem('persistenceVisibility.showTemplateNameInput')}>
          ...
          <div className="space-y-2" {...canvasOwnerSettingDefinitionItem('persistenceVisibility.showLayoutResizeModeSelect')}>
          ...
          <div className="col-span-2 space-y-2" {...canvasOwnerSettingDefinitionItem('persistenceVisibility.showSourceDocumentNameInput')}>
        ...
        {showSaveButton ? (
        <Button
          {...canvasOwnerSettingDefinitionItem('persistenceVisibility.showSaveButton')}
