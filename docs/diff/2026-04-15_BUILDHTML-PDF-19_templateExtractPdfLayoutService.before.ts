...
const buildCloneStyleHtml = (version: '13' | '14' | '15' | '16' | '17' | '18') => `    <style>
...
${buildCloneStyleHtml(version)}
    <h1>작업지시서</h1>
${version === '18' ? buildWorkOrderGridHtmlV18(structured, layout) : version === '17' ? buildUnifiedWorkOrderTableHtml(structured) : `${buildMetadataHtml(structured.metadataFields)}
