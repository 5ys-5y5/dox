...
export const buildCanvasToolbarVisibility = (
  ...
  showTemplateNameInput: settings.showCanvasNameField && workspaceRuntime === 'template',
  showSaveButton: settings.showCanvasSaveButton && workspaceRuntime !== 'read',
  showTodoButton: settings.showCanvasTodoButton && workspaceRuntime === 'document',
  showPreviewToggle: settings.showCanvasPreviewToggle && workspaceRuntime === 'template',
  showInteractionModeControls: settings.showCanvasInteractionModeControls && workspaceRuntime === 'template',
  showHistoryControls: settings.showCanvasHistoryControls && workspaceRuntime !== 'read',
  showZoomControls: settings.showCanvasZoomControls,
  showFullscreenControl: settings.showCanvasFullscreenControl,
  showEditSettingsToggle: settings.showCanvasEditSettingsToggle && workspaceRuntime === 'template',
  showSelectionPanelTabs: settings.showCanvasSelectionPanelTabs && workspaceRuntime === 'template',
});
...
export const applyCanvasOwnerSettingsToWorkspaceProps = ({
  ...
  if (shouldApplySetting('showCanvasNameField')) {
    canvasToolbarVisibility.showTemplateNameInput = settings.showCanvasNameField && normalizedWorkspaceRuntime === 'template';
  }
  if (shouldApplySetting('showCanvasSaveButton')) {
    canvasToolbarVisibility.showSaveButton = settings.showCanvasSaveButton && normalizedWorkspaceRuntime !== 'read';
  }
  if (shouldApplySetting('showCanvasTodoButton')) {
    canvasToolbarVisibility.showTodoButton = settings.showCanvasTodoButton && normalizedWorkspaceRuntime === 'document';
  }
  if (shouldApplySetting('showCanvasPreviewToggle')) {
    canvasToolbarVisibility.showPreviewToggle = settings.showCanvasPreviewToggle && normalizedWorkspaceRuntime === 'template';
  }
  if (shouldApplySetting('showCanvasInteractionModeControls')) {
    canvasToolbarVisibility.showInteractionModeControls =
      settings.showCanvasInteractionModeControls && normalizedWorkspaceRuntime === 'template';
  }
  if (shouldApplySetting('showCanvasHistoryControls')) {
    canvasToolbarVisibility.showHistoryControls = settings.showCanvasHistoryControls && normalizedWorkspaceRuntime !== 'read';
  }
  ...
  if (shouldApplySetting('showCanvasEditSettingsToggle')) {
    canvasToolbarVisibility.showEditSettingsToggle =
      settings.showCanvasEditSettingsToggle && normalizedWorkspaceRuntime === 'template';
  }
  if (shouldApplySetting('showCanvasSelectionPanelTabs')) {
    canvasToolbarVisibility.showSelectionPanelTabs =
      settings.showCanvasSelectionPanelTabs && normalizedWorkspaceRuntime === 'template';
  }
  ...
  return {
    ...
    templateListDisplay:
      normalizedWorkspaceRuntime === 'template'
    ...
    saveDisabled: shouldApplySetting('saveDisabled')
      ? Boolean(baseProps.saveDisabled || normalizedWorkspaceRuntime === 'read' || settings.saveDisabled)
      : Boolean(baseProps.saveDisabled || normalizedWorkspaceRuntime === 'read'),
    ...
    documentAttachmentApiPath:
      normalizedWorkspaceRuntime === 'document' &&
