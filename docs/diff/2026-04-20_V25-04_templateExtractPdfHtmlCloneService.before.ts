...
type RuleTextCloneOptions = {
  ...
  textLayoutMode?: 'clustered_chars' | 'distributed_chars' | 'line_box';
};
...
const resolvePdfFontFamily = (fontName: string | undefined, rawText = '') => {
...
const buildRuleTextSvgTextElement = (
  ...
  const pdfFontFamily = options.usePdfFontMetrics ? resolvePdfFontFamily(line.fontName, rawText) : null;
