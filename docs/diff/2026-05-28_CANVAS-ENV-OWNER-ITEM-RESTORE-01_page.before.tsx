...
const canvasOwnerSettingDefinitionItem = (definitionName: string) => ({
  'data-canvas-owner-item': definitionName,
  'data-canvas-owner-name': definitionName,
  'data-canvas-owner-setting-definition': definitionName,
});
...
export default function CanvasOwnerPage() {
  ...
  const topNotice = previewSettings.showTopNotice ? (
    <div
      ...
      {...canvasOwnerSettingDefinitionItem('topNotice')}
    >
  ...
  const additionalControlPanels = (
    ...
    <div
      ...
      {...canvasOwnerSettingDefinitionItem('additionalControlPanels')}
    >
  ...
  const canvasConfigRows = [
    ...
    },
    {
      ...
      disabled: workspaceRuntime === 'read',
    ...
    },
    {
      ...
      disabled: workspaceRuntime === 'template',
    ...
    },
    {
      ...
      disabled: workspaceRuntime !== 'template' || !canEditCurrentWorkspace,
  ...
  const renderPageSettingsImportSection = () => (
    <div className="space-y-3">
      ...
      <div className="space-y-1.5" {...canvasOwnerSettingDefinitionItem('canvasViewMode')}>
    ...
    <div className="space-y-1.5">
      ...
      <div className="grid gap-2 lg:grid-cols-2">
        <div
          ...
          {...canvasOwnerSettingDefinitionItem('autoCanvasHeight')}
        >
          ...
          {settings.autoCanvasHeight ? null : (
            <div className={getTextSettingClassName('specifiedCanvasHeight')} {...canvasOwnerSettingDefinitionItem('specifiedCanvasHeight')}>
        ...
        <div
          ...
          {...canvasOwnerSettingDefinitionItem('autoCanvasWidth')}
        >
          <div className="flex items-start justify-between gap-2">
            <div className="min-w-0">
              <div className="flex items-center gap-1.5 text-[11px] font-semibold text-slate-800">
          ...
          {settings.autoCanvasWidth ? null : (
            <div className={getTextSettingClassName('specifiedCanvasWidth')} {...canvasOwnerSettingDefinitionItem('specifiedCanvasWidth')}>
              <label className="flex items-center justify-between gap-2 text-[11px] font-medium text-slate-700">
                <span>너비 값</span>
    ...
    return (
      <div className="space-y-1.5">
        ...
        <div
          ...
          {...canvasOwnerSettingDefinitionItem('selectionInactiveOverlayOpacity')}
        >
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              <div className="flex items-center gap-1.5 text-[11px] font-semibold text-slate-800">
  ...
  const renderCanvasTextSettings = () => (
    <div className="grid gap-2 sm:grid-cols-2 xl:grid-cols-5">
      <div className={getTextSettingClassName('headerTitle')} {...canvasOwnerSettingDefinitionItem('headerTitle')}>
        <label className="flex items-center justify-between gap-2 text-[11px] font-medium text-slate-700">
      ...
      <div className={getTextSettingClassName('headerDescription')} {...canvasOwnerSettingDefinitionItem('headerDescription')}>
        <label className="flex items-center justify-between gap-2 text-[11px] font-medium text-slate-700">
      ...
      <div className={getTextSettingClassName('nameFieldLabel')} {...canvasOwnerSettingDefinitionItem('nameFieldLabel')}>
        <label className="flex items-center justify-between gap-2 text-[11px] font-medium text-slate-700">
      ...
      <div className={getTextSettingClassName('saveButtonLabel')} {...canvasOwnerSettingDefinitionItem('saveButtonLabel')}>
        <label className="flex items-center justify-between gap-2 text-[11px] font-medium text-slate-700">
      ...
      <div className={getTextSettingClassName('templateListDisplay')} {...canvasOwnerSettingDefinitionItem('templateListDisplay')}>
        <label className="flex items-center justify-between gap-2 text-[11px] font-medium text-slate-700">
              ...
              {section.rows.map((row) => {
                ...
                return (
                  <div
                    ...
                    {...canvasOwnerSettingDefinitionItem(row.definitionName)}
                  >
                    <SettingToggleRow
                      label={row.label}
