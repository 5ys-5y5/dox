import type { TemplateExtractPdfLayoutModel, TemplateExtractPdfLine } from '../lib/templateExtractDtos';
  ...
  const pagesHtml = layout.pages
    .map((page) => {
      ...
      return `    <div class="template-clone__pdf-page" data-page="${page.pageNumber}" style="width:${page.width.toFixed(
        ...
        page.backgroundImageDataUrl
          ? `      <img class="template-clone__pdf-page-image" src="${escapeAttribute(page.backgroundImageDataUrl)}" alt="PDF page ${page.pageNumber}" />\n`
          : ''
