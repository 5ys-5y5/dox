...
const resolveAuthRecord = async (params: {
  ...
  let query = client.from('sign_authentications').select('*');
...
export const SignAuthService = {
  ...
  async cancelAuthentication(params: {
    ...
    const { data: cancelledAuthData, error: cancelError } = await client
      .from('sign_authentications')
  ...
  async verifyAuthentication(params: {
    ...
    const { data: verifiedAuthData, error: verifyError } = await client
      .from('sign_authentications')
      .update({
  ...
  async receiveCallback(params: {
    ...
    const { data: callbackAuthData, error: callbackError } = await client
      .from('sign_authentications')
      .update({
