-- sign_requests.id = 9854df9b-0eaf-44b1-9b82-da2156caec8a 무결성 점검 SQL
...
--      docs/run-this-supabase-integrity-signature-guard.sql 실행 완료

WITH target AS (
    SELECT '9854df9b-0eaf-44b1-9b82-da2156caec8a'::uuid AS request_id
),
sr AS (
    SELECT sr.*
