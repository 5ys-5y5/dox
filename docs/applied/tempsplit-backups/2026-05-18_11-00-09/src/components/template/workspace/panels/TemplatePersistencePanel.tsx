  ...
  <div className="space-y-6">
    ...
    <Card className="border-slate-200">
      ...
      <CardContent className="space-y-4">
        <div className={`grid gap-4 ${hideHeader ? 'xl:grid-cols-[1.2fr_auto]' : 'grid-cols-1'}`}>
          ...
          {hideHeader ? (
            <div className="flex items-end">
              <Button className="h-11 min-h-11" onClick={onSave} disabled={saving || loading || !renderedPreviewHtml.trim() || templateUsagePreviewMode}>
        ...
        <div className={`grid gap-4 ${hideHeader ? 'md:grid-cols-3' : 'grid-cols-1'}`}>
          {hideHeader ? (
            <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Input value={sourceDocumentName} onChange={(event) => onSourceDocumentNameChange(event.target.value)} />
          </div>
          <div className="space-y-2">
